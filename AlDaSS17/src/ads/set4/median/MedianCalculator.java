	...
	*/
	...
	private static int elementAt(int[] numbers, int index, int groupSize) {
		...
		if (numbers.length <= groupSize) {
			// abbruch der rekursion bei begrentzer größe -> kein einfluß auf
